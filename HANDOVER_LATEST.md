...
- ★2edge束ね(順張り+逆張り)無効。月次相関0.112だがedge2が複利で壊滅する以上束ね意味なし
...
- 2026-06-03 v2.6 cfs27/28反映: ★★逆張りは複利で壊滅・2edge束ね無効・cron復旧・次はcfs29
- 2026-06-03 v2.7 当日ML統計統合: mult統計再確認(外挿値のみ、真値=1.141x変わらず)。新規棄却なし。cfs29が次アクション確定